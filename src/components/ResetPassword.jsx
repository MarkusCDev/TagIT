...
const ResetPassword = () => {
    ...
    {/* Handles Firebase send Password Reset Email to valid Firebase Account Email */}
          ...
          <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl m-auto bg-white rounded-lg p-5">
            ...
            <img className="w-20 h-20 mx-auto mb-5" src={ccnyimg} alt="CCNY Logo" />
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Submit Button */}
                <button
                  className="w-full bg-indigo-700 hover:bg-purple-700 text-white font-bold py-2 px-4 mb-6 rounded transition-colors duration-300" type="submit">Send Reset Email</button>
              </form>
      
            {/* Additional Links */}
            <div className="flex justify-between">
              <Link className="text-indigo-700 hover:text-purple-700 text-sm" to="/login">Login Here</Link>
